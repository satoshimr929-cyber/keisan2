...
export const STAGES = [
  {
    id: 'st01', name: 'はじまりの草原', grade: '4年', ico: 'sprout', uc: '#5aa0ff', tier: 1,
    pool: ['tasi', 'hiki'],
  ...
  {
    id: 'st02', name: 'ざわめきの森', grade: '4年', ico: 'tree', uc: '#46d36a', tier: 2,
    pool: ['kake', 'wari'],
  ...
  {
    id: 'st03', name: 'きりの谷', grade: '4年', ico: 'mist', uc: '#7f8cff', tier: 3,
    pool: ['gaisu', 'junjo'],
  ...
  {
    id: 'st04', name: 'しずくの泉', grade: '4年', ico: 'water', uc: '#46d3c0', tier: 4,
    pool: ['decas'],
  ...
  {
    id: 'st05', name: 'みずうみの里', grade: '4年', ico: 'lake', uc: '#5ad0ff', tier: 5,
  ...
  {
    id: 'st06', name: 'こおりの洞くつ', grade: '5年', ico: 'ice', uc: '#7fd0ff', tier: 6,
    pool: ['koubai', 'kouyaku'],
  ...
  {
    id: 'st07', name: 'つらら回廊', grade: '5年', ico: 'icicle', uc: '#9ad8ff', tier: 7,
    pool: ['idenbun'],
  ...
  {
    id: 'st08', name: 'ほのおの山道', grade: '5年', ico: 'fire', uc: '#ff7a4a', tier: 8,
  ...
  {
    id: 'st09', name: 'ようがんの間', grade: '5年', ico: 'volcano', uc: '#ff5a55', tier: 9,
    pool: ['heikin', 'wariai'],
  ...
  {
    id: 'st10', name: 'やみの神殿', grade: '6年', ico: 'darkmoon', uc: '#a07bff', tier: 10,
    pool: ['fracmul'],
  ...
  {
    id: 'st11', name: 'しんえんの祭壇', grade: '6年', ico: 'orb', uc: '#c77bff', tier: 11,
    pool: ['fracdiv'],
  ...
  {
    id: 'st12', name: 'けいさん王の玉座', grade: '6年', ico: 'crown', uc: '#ffcf3f', tier: 12,
...
/** ステージ間の座標マップ（ワールドマップ用 / viewBox 0 0 180 100）*/
export const STAGE_MAP_POS = [
  { x:  14, y: 82 },  // st01 草原  ─ 左端草原
  { x:  28, y: 66 },  // st02 森    ─ 左森
  { x:  42, y: 55 },  // st03 霧谷  ─ 中央左
  { x:  55, y: 44 },  // st04 泉    ─ 中央
  { x:  63, y: 31 },  // st05 湖    ─ 中央上
  { x:  77, y: 19 },  // st06 氷洞  ─ 雪エリア手前
  { x:  91, y: 10 },  // st07 霜廊  ─ 雪山ピーク
  { x: 106, y: 21 },  // st08 火山  ─ 雪→炎
  { x: 116, y: 54 },  // st09 溶岩  ─ 溶岩エリア
  { x: 132, y: 43 },  // st10 暗殿  ─ 暗黒城入口
  { x: 150, y: 60 },  // st11 祭壇  ─ 奥の祭壇
  { x: 163, y: 46 },  // st12 玉座  ─ ラストボス
];
